  ...
  return (
    <>
      ...
      <nav className="hidden md:block w-64 bg-slate-900 text-white p-6 min-h-screen shrink-0">
        ...
        <div className="mt-6 mb-8 border-b border-slate-700 pb-6">
          <p className="text-sm text-slate-400">Logged in as</p>

          <span className="inline-block mt-3 px-3 py-1 rounded-full text-xs font-semibold bg-green-600/20 text-green-400">
            {user?.role || "Admin"}
          </span>
        </div>
        ...
        <ul className="space-y-4 font-medium">
          <li>
            <Link
              to="/"
              className="block py-2 px-4 rounded hover:bg-slate-800 transition-colors"
            >
              Dashboard
            </Link>
          </li>
